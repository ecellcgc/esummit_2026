...
const competitionsData = [
    ...
    },
    {
        id: 2,
        title: "IPL AUCTION",
        description: "Experience the thrill of strategy and bidding in the IPL Auction. Teams compete to build the strongest squad within a fixed virtual budget through a live auction.",
    ...
    return (
        ...
        >
            ...
            <div className="w-full text-center mb-8">
                ...
                <div className="inline-flex items-center gap-3 mx-auto bg-gradient-to-r from-orange-700/30 to-yellow-500/20 border border-white/10 rounded-full px-4 py-2 text-sm wx-5 text-white/90 shadow-sm">
                        ...
                        <div className="relative aspect-[3/4] w-full overflow-hidden cursor-pointer flex-shrink-0">
                            ...
                            <div className="absolute inset-0 z-[5] flex flex-col justify-end bg-gradient-to-t from-black/95 via-black/60 to-transparent opacity-100 transition-opacity duration-300">
                                <div className="p-3 pt-8 translate-y-0 transition-transform duration-300">
                                    ...
                                    <p className="text-white/95 text-xs sm:text-sm leading-relaxed line-clamp-4">{comp.description}</p>
